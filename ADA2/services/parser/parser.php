...
class Parser
{
    ...
    public function parseQuery($query)
    {
        ...
        $transformed_query = $this->setQueryWithoutSpacesInPars($query);
        ...
        foreach ($tokens as $token) {
            ...
            if ($type != 'OPERATOR' && $before_type != 'OPERATOR' && $before_type != null && $before_type != 'NO-VALUE') {
    ...
    private function setQueryWithoutSpacesInPars($query)
    {
